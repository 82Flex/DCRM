...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('WEIPDCRM', '0027_auto_20170216_1553'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='version',
            name='author_email',
            field=models.EmailField(blank=True, default='', max_length=255, null=True, verbose_name='Author Email'),
        ),
        migrations.AlterField(
            model_name='version',
            name='author_name',
            field=models.CharField(blank=True, default='', help_text='In contrast, the person who wrote the original software is called the "author". This name will be shown underneath the name of the package on the details screen. The field is in the same format as "Maintainer".', max_length=255, null=True, verbose_name='Author'),
        ),
        migrations.AlterField(
            model_name='version',
            name='breaks',
        ...
        migrations.AlterField(
            model_name='version',
            name='bugs',
            field=models.URLField(blank=True, default='', help_text='The url of the bug tracking system for this package. The current used format is bts-type://bts-address, like debbugs://bugs.debian.org.', null=True, verbose_name='Bugs'),
        ),
        migrations.AlterField(
            model_name='version',
        ...
        migrations.AlterField(
            model_name='version',
            name='essential',
            field=models.CharField(blank=True, choices=[(None, 'None'), ('yes', 'Yes'), ('no', 'No')], default='', help_text='This field is usually only needed when the answer is yes. It denotes a package that is required for proper operation of the system. Dpkg or any other installation tool will not allow an Essential package to be removed (at least not without using one of the force options).', max_length=255, null=True, verbose_name='Essential'),
        ),
        migrations.AlterField(
            model_name='version',
            name='homepage',
        ...
        migrations.AlterField(
            model_name='version',
            name='installed_size',
            field=models.BigIntegerField(blank=True, default=0, help_text="The approximate total size of the package's installed files, in KiB units.", null=True, verbose_name='Installed-Size'),
        ),
        migrations.AlterField(
            model_name='version',
        ...
        migrations.AlterField(
            ...
            field=models.EmailField(blank=True, default='', max_length=255, null=True, verbose_name='Maintainer Email'),
        ),
        migrations.AlterField(
            model_name='version',
            name='maintainer_name',
            field=models.CharField(blank=True, default='', help_text='It is typically the person who created the package, as opposed to the author of the software that was packaged.', max_length=255, null=True, verbose_name='Maintainer'),
        ),
        migrations.AlterField(
            model_name='version',
            name='multi_arch',
        ...
        migrations.AlterField(
            model_name='version',
            name='sponsor_site',
            field=models.URLField(blank=True, default='', max_length=255, null=True, verbose_name='Sponsor Site'),
        ),
        migrations.AlterField(
            model_name='version',
        ...
        migrations.AlterField(
            model_name='version',
            name='tag',
            field=models.TextField(blank=True, default='', help_text='List of tags describing the qualities of the package. The description and list of supported tags can be found in the debtags package.', null=True, verbose_name='Tag'),
        ),
    ]
