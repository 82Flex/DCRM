# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-02 18:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('redirect_resources', models.IntegerField(choices=[(0, 'None'), (1, 'Moved'), (2, 'Accel')], default=0, help_text='None - Read resources and return.Moved - Return 301/302 responses to the real resource urls.<br />Accel - Redirect resource requests to WEB servers without changing urls.', verbose_name='Redirect Methods')),
