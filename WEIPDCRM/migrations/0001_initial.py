# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-02 08:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advanced_mode', models.BooleanField(default=False, help_text='Check it to generate awesome depiction page for each version.', validators=[WEIPDCRM.models.setting.validate_advanced_mode], verbose_name='Auto Depiction')),
                ...
                ('web_server', models.IntegerField(choices=[(0, 'Nginx'), (1, 'Apache'), (2, 'Tomcat'), (3, 'Lighttpd')], default=0, help_text='This will help DCRM redirect download request properly.', validators=[WEIPDCRM.models.setting.validate_web_server], verbose_name='Web Server')),
                ('download_count', models.BooleanField(default=False, help_text='Count every download. You should configure Nginx or other HTTP servers before you enable this feature.', verbose_name='Download Count')),
                ('download_cydia_only', models.BooleanField(default=False, help_text='Protect downloading from any other tools except Cydia. You should configure Nginx or other HTTP servers before you enable this feature.', verbose_name='Cydia Only')),
        ...
        migrations.RunSQL(
            "CREATE VIEW `package_view` AS SELECT `id`, `c_name`, `created_at`, `c_package`, `c_version`, `c_section_id`, `enabled`, `online_icon` FROM `WEIPDCRM_version` WHERE `enabled` = TRUE GROUP BY `c_package` DESC;"
        ),
        migrations.RunSQL(
