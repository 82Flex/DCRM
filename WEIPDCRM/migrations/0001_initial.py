...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            "CREATE VIEW `package_view` AS SELECT `id`, `c_name`, `created_at`, `c_package`, `c_version`, `c_section_id`, `enabled`, `online_icon`, SUM(`download_times`) AS `download_count` FROM `WEIPDCRM_version` WHERE `enabled` = TRUE GROUP BY `c_package` DESC;"
        ),
        migrations.RunSQL(
