    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descriptor', models.CharField(help_text='Example: iPhone 7 Plus', max_length=255, validators=[django.core.validators.RegexValidator(re.compile('^[-a-zA-Z0-9_]+\\Z'), "Enter a valid 'slug' consisting of letters, numbers, underscores or hyphens.", 'invalid')], verbose_name='Descriptor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('build', models.CharField(help_text='Example: 14C92', max_length=255, validators=[django.core.validators.RegexValidator(re.compile('^[-a-zA-Z0-9_]+\\Z'), "Enter a valid 'slug' consisting of letters, numbers, underscores or hyphens.", 'invalid')], verbose_name='Build')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('packages_compression', models.IntegerField(choices=[(0, 'plain'), (1, 'gzip'), (2, 'plain and gzip'), (3, 'bzip'), (4, 'plain and bzip'), (5, 'gzip and bzip'), (6, 'all')], default=6, help_text='Please change the compression method if error occurred when try to rebuild the list.', verbose_name='packages Compression')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage', models.FileField(upload_to='debs', verbose_name='Storage')),
                ('icon', models.ImageField(blank=True, default='', help_text='Choose an Icon (*.png) to upload', upload_to='package-icons', verbose_name='Icon')),
                ('md5', models.CharField(default='', max_length=32, verbose_name='MD5Sum')),
                ('sha1', models.CharField(default='', max_length=40, verbose_name='SHA1')),
                ('sha256', models.CharField(default='', max_length=64, verbose_name='SHA256')),
                ('sha512', models.CharField(default='', max_length=128, verbose_name='SHA512')),
                ('size', models.BigIntegerField(default=0, help_text='The exact size of the package, in bytes.', verbose_name='Size')),
                ('download_times', models.IntegerField(default=0, verbose_name='Download Times')),
                ('installed_size', models.BigIntegerField(blank=True, default=0, help_text="The approximate total size of the package's installed files, in KiB units.", null=True, verbose_name='Installed-Size')),
                ('package', models.CharField(help_text='This is the "identifier" of the package. This should be, entirely in lower case, a reversed hostname (much like a "bundleIdentifier" in Apple\'s Info.plist files).', max_length=255, validators=[WEIPDCRM.models.version.validate_reversed_domain], verbose_name='Package')),
                ('version', models.CharField(default='1.0-1', help_text="A package's version indicates two separate values: the version of the software in the package, and the version of the package itself. These version numbers are separated by a hyphen.", max_length=255, validators=[WEIPDCRM.models.version.validate_version], verbose_name='Version')),
                ...
                ('description', models.TextField(blank=True, default='', help_text='The first line (after the colon) should contain a short description to be displayed on the package lists underneath the name of the package. Optionally, one can choose to replace that description with an arbitrarily long one that will be displayed on the package details screen.', null=True, verbose_name='Description')),
                ('tag', models.TextField(blank=True, default='', help_text='List of tags describing the qualities of the package. The description and list of supported tags can be found in the debtags package.', null=True, verbose_name='Tag')),
                ('architecture', models.CharField(blank=True, default='', help_text='This describes what system a package is designed for, as .deb files are used on everything from the iPhone to your desktop computer. The correct value for iPhoneOS 1.0.x/1.1.x is "darwin-arm". If you are deploying to iPhoneOS 1.2/2.x you should use "iphoneos-arm".', max_length=255, null=True, validators=[django.core.validators.RegexValidator(re.compile('^[-a-zA-Z0-9_]+\\Z'), "Enter a valid 'slug' consisting of letters, numbers, underscores or hyphens.", 'invalid')], verbose_name='Architecture')),
                ('name', models.CharField(blank=True, default='Untitled Package', help_text='When the package is shown in Cydia\'s lists, it is convenient to have a prettier name. This field allows you to override this display with an arbitrary string. This field may change often, whereas the "Package" field is fixed for the lifetime of the package.', max_length=255, null=True, verbose_name='Name')),
                ...
                ('depiction', models.URLField(blank=True, default='', help_text='This is a URL that is loaded into an iframe, replacing the Description: and Homepage: .', null=True, verbose_name='Depiction')),
                ...
                ('homepage', models.URLField(blank=True, default='', help_text='Cydia supports a "More Info" field on the details screen that shunts users off to a website of the packager\'s choice.', null=True, verbose_name='Homepage')),
                ('priority', models.CharField(blank=True, choices=[(None, '-'), ('required', 'Required'), ('standard', 'Standard'), ('optional', 'Optional'), ('extra', 'Extra')], default='', help_text='Sets the importance of this package in relation to the system as a whole.  Common priorities are required, standard, optional, extra, etc.', max_length=255, null=True, verbose_name='Priority')),
                ('essential', models.CharField(blank=True, choices=[(None, '-'), ('yes', 'Yes'), ('no', 'No')], default='', help_text='This field is usually only needed when the answer is yes. It denotes a package that is required for proper operation of the system. Dpkg or any other installation tool will not allow an Essential package to be removed (at least not without using one of the force options).', max_length=255, null=True, verbose_name='Essential')),
                ('depends', models.TextField(blank=True, default='', help_text="List of packages that are required for this package to provide a non-trivial amount of functionality. The package maintenance software will not allow a package to be installed if the packages listed in its Depends field aren't installed (at least not without using the force options).  In an installation, the postinst scripts of packages listed in Depends fields are run before those of the packages which depend on them. On the opposite, in a removal, the prerm script of a package is run before those of the packages listed in its Depends field.", null=True, validators=[WEIPDCRM.models.version.validate_relations], verbose_name='Depends')),
                ('pre_depends', models.TextField(blank=True, default='', help_text='List of packages that must be installed and configured before this one can be installed. This is usually used in the case where this package requires another package for running its preinst script.', null=True, validators=[WEIPDCRM.models.version.validate_relations], verbose_name='Pre-Depends')),
                ('recommends', models.TextField(blank=True, default='', help_text='Lists packages that would be found together with this one in all but unusual installations. The package maintenance software will warn the user if they install a package without those listed in its Recommends field.', null=True, validators=[WEIPDCRM.models.version.validate_relations], verbose_name='Recommends')),
                ('suggests', models.TextField(blank=True, default='', help_text='Lists packages that are related to this one and can perhaps enhance its usefulness, but without which installing this package is perfectly reasonable.', null=True, validators=[WEIPDCRM.models.version.validate_relations], verbose_name='Suggests')),
                ('breaks', models.TextField(blank=True, default='', help_text='Lists packages that this one breaks, for example by exposing bugs when the named packages rely on this one. The package maintenance software will not allow broken packages to be configured; generally the resolution is to upgrade the packages named in a Breaks field.', null=True, validators=[WEIPDCRM.models.version.validate_relations], verbose_name='Breaks')),
                ('conflicts', models.TextField(blank=True, default='', help_text='Lists packages that conflict with this one, for example by containing files with the same names. The package maintenance software will not allow conflicting packages to be installed at the same time. Two conflicting packages should each include a Conflicts line mentioning the other.', null=True, validators=[WEIPDCRM.models.version.validate_relations], verbose_name='Conflicts')),
                ('replaces', models.TextField(blank=True, default='', help_text='List of packages files from which this one replaces. This is used for allowing this package to overwrite the files of another package and is usually used with the Conflicts field to force removal of the other package, if this one also has the same files as the conflicted package.', null=True, validators=[WEIPDCRM.models.version.validate_relations], verbose_name='Replaces')),
                ('provides', models.TextField(blank=True, default='', help_text='This is a list of virtual packages that this one provides. Usually this is used in the case of several packages all providing the same service. For example, sendmail and exim can serve as a mail server, so they provide a common package ("mail-transport-agent") on which other packages can depend. This will allow sendmail or exim to serve as a valid option to satisfy the dependency.  This prevents the packages that depend on a mail server from having to know the package names for all of them, and using \'|\' to separate the list.', null=True, validators=[WEIPDCRM.models.version.validate_relations], verbose_name='Provides')),
                ('origin', models.CharField(blank=True, default='', help_text='The name of the distribution this package is originating from.', max_length=255, null=True, verbose_name='Origin')),
                ('source', models.CharField(blank=True, default='', help_text='The name of the source package that this binary package came from, if it is different than the name of the package itself. If the source version differs from the binary version, then the source-name will be followed by a source-version in parenthesis.', max_length=255, null=True, verbose_name='Source')),
                ('build_essential', models.CharField(blank=True, choices=[(None, '-'), ('yes', 'Yes'), ('no', 'No')], default='', help_text='This field is usually only needed when the answer is yes, and is commonly injected by the archive software.  It denotes a package that is required when building other packages.', max_length=255, null=True, verbose_name='Build-Essential')),
                ('bugs', models.CharField(blank=True, default='', help_text='The url of the bug tracking system for this package. The current used format is bts-type://bts-address, like debbugs://bugs.debian.org.', max_length=255, null=True, validators=[WEIPDCRM.models.version.validate_bugs], verbose_name='Bugs')),
                ('multi_arch', models.CharField(blank=True, choices=[('no', 'No'), ('same', 'Same'), ('foreign', 'Foreign'), ('allowed', 'Allowed')], default='', help_text='This field is used to indicate how this package should behave on a multi-arch installations.<br /><ul><li>no - This value is the default when the field is omitted, in which case adding the field with an explicit no value is generally not needed.</li><li>same - This package is co-installable with itself, but it must not be used to satisfy the dependency of any package of a different architecture from itself.</li><li>foreign - This package is not co-installable with itself, but should be allowed to satisfy a non-arch-qualified dependency of a package of a different arch from itself (if a dependency has an explicit arch-qualifier then the value foreign is ignored).</li><li>allowed - This allows reverse-dependencies to indicate in their Depends field that they accept this package from a foreign architecture by qualifying the package name with :any, but has no effect otherwise.</li></ul>', max_length=255, null=True, verbose_name='Multi-Arch')),
                ('subarchitecture', models.CharField(blank=True, default='', max_length=255, null=True, validators=[django.core.validators.RegexValidator(re.compile('^[-a-zA-Z0-9_]+\\Z'), "Enter a valid 'slug' consisting of letters, numbers, underscores or hyphens.", 'invalid')], verbose_name='Subarchitecture')),
                ('kernel_version', models.CharField(blank=True, default='', max_length=255, null=True, validators=[WEIPDCRM.models.version.validate_version], verbose_name='Kernel-Version')),
                ('installer_menu_item', models.TextField(blank=True, default='', help_text='These fields are used by the debian-installer and are usually not needed. See /usr/share/doc/debian-installer/devel/modules.txt from the debian-installer package for more details about them.', null=True, verbose_name='Installer-Menu-Item')),
                ('built_using', models.TextField(blank=True, default='', help_text="This field lists extra source packages that were used during the build of this binary package.  This is an indication to the archive maintenance software that these extra source packages must be kept whilst this binary package is maintained. This field must be a list of source package names with strict '=' version relationships.  Note that the archive maintenance software is likely to refuse to accept an upload which declares a Built-Using relationship which cannot be satisfied within the archive.", null=True, validators=[WEIPDCRM.models.version.validate_relations], verbose_name='Built-Using')),
                ('built_for_profiles', models.TextField(blank=True, default='', help_text='This field specifies a whitespace separated list of build profiles that this binary packages was built with.', null=True, verbose_name='Built-For-Profiles')),
                ...
                ('section', models.ForeignKey(blank=True, default='', help_text='Under the "Install" tab in Cydia, packages are listed by "Section". If you would like to encode a space into your section name, use an underscore (Cydia will automatically convert these).', null=True, on_delete=django.db.models.deletion.SET_NULL, to='WEIPDCRM.Section', verbose_name='Section')),
            ],
            options={
